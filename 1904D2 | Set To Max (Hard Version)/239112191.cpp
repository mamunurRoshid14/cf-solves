...
void solve(){
    ...
    for(auto ii:vv){
        ...
        bool f1=0,f2=0;
        if(l!=n&&t1.query(1,1,n,l,i+1)<=bb[i]&&t2.query(1,1,n,l,i+1)>=bb[i])
        {
            cn++;
            f1=1;
            t1.upd(1,1,n,l,i+1,bb[i]);
        }
        if(r!=-1&&t1.query(1,1,n,i+1,r)<=bb[i]&&t2.query(1,1,n,i+1,r)>=bb[i]){
            cn++;
            f2=1;
            t1.upd(1,1,n,i+1,r,bb[i]);
        }
//        if(f1&&f2){
//            if(i-l<r-i){
//                t1.upd(1,1,n,l,i+1,bb[i]);
